...
const items = [
  // introduction
  {
    ...
    content: (
      <>
      <h2 className="font-bold text-[1.8rem] sm:text-2xl mb-5 text-[rgb(63,66,100)] tracking-tight [text-shadow:0_0_1px_rgba(0,0,0,0.3)]">
  بوت کمپ فرانت اند زمستان ۱۴۰۴؛ شروعی مطمئن برای برنامه نویسی
        ...
        <p className=" text-gray-600 ">
          ...
          مسیری است که شما را به یک ،     
          <strong >برنامه‌نویس آماده کار </strong> تبدیل می‌کند. این دوره به شکلی
          طراحی شده که حتی اگر از صفر شروع کنید، پس از پایان آن نیازی به هیچ
          دوره آموزشی دیگری نخواهید داشت.
        </p>

        <h2 className="font-bold text-[1.8rem] sm:text-2xl my-5 text-[rgb(63,66,100)] tracking-tight [text-shadow:0_0_1px_rgba(0,0,0,0.3)]">
  ورکشاپ کاریابی و پول سازی؛ برگ برنده بوت کمپ
</h2>

        <p className="text-gray-600">
          یکی از بخش‌های کلیدی و منحصربه‌فرد این بوت‌کمپ،
          <strong>ورکشاپ کاریابی و درآمدزایی از لینکدین</strong> است. این ورکشاپ
          به شما کمک می‌کند مهارت‌هایتان را به فرصت‌های واقعی شغلی تبدیل کنید.
          با حضور در این ورکشاپ، دیگر لازم نیست ماه‌ها منتظر بمانید تا رزومه شما
          دیده شود یا ناامید شوید. ما به شما نشان می‌دهیم چگونه با یک مسیر
          اصولی، خیلی زود وارد بازار کار برنامه‌نویسی فرانت‌اند شوید و اولین
          درآمد خود را تجربه کنید.
        </p>

        <h2 className="font-bold text-[1.8rem] sm:text-2xl mb-5 text-[rgb(63,66,100)] tracking-tight [text-shadow:0_0_1px_rgba(0,0,0,0.3)]">هدف اصلی بوت کمپ فرانت</h2>
        <p className="text-gray-600">
          هدف اصلی این دوره، تبدیل شما به یک{" "}
          <strong>توسعه‌دهنده فرانت‌اند</strong> است که بتواند تمام کارهای لازم
          در این حوزه را به خوبی انجام دهد. شما یاد می‌گیرید از{" "}
          <strong>کدنویسی</strong> لی‌اوت (طراحی سایت) گرفته تا پیاده‌سازی یک
          وب‌سایت داینامیک با ری‌اکت و نکست و برقراری ارتباط با سرور را به خوبی
          انجام دهید. همچنین به‌صورت قطعی یاد خواهید گرفت چگونه یک اپلیکیشن وب
          را با استفاده از ری‌اکت به‌تنهایی یا در تیم توسعه داده و با استفاده از
          گیت، مدیریت کنید. این دوره از آموزش HTML و CSS شروع شده و در ادامه، با
          یادگیری مفاهیم ری‌اکت، به مهارتی می‌رسید که بتوانید به‌تنهایی یک وب
          اپلیکیشن ری‌اکت یا نکست را کدنویسی کنید.
        </p>
      </>
    ),
  },
  //   requierd
  {
    ...
    content: (
      < >
        <h2 className=" 
font-bold text-[1.8rem] sm:text-2xl  text-[rgb(63,66,100)] tracking-tight [text-shadow:0_0_1px_rgba(0,0,0,0.3)]        ">مرور چند نکته مهم</h2>
        <ul className="list-disc list-inside space-y-2 text-lg my-5 text-gray-600">
          ...
          <li>
            رشته تحصیلی هیچ ارتباطی با توانایی شما در برنامه‌نویسی ندارد! حتی
            اگر رشته شما پرستاری، هنر، حقوق، مهندسی و … بوده است، می‌توانید
            برنامه‌نویسی را یاد بگیرید و ثبت‌نام کنید.
          </li>
          <li>
            در دوره‌های قبلی، افراد زیادی با رنج سنی ۳۰ تا ۴۵ سال شرکت کرده‌اند.
            سن معیار اصلی نیست، اما مهم است که در کنار سایر مسئولیت‌ها، زمان
            کافی برای یادگیری داشته باشید.
          </li>
          <li>
            تنها شرط ثبت‌نام داشتن زمان کافی برای تمرین روزانه است. حداقل ۲ ساعت
            در روز نیاز داریم. برنامه‌ریزی روزانه و هفتگی دوره بر اساس همین ۲
            ساعت انجام شده است. اگر این زمان برای شما فراهم نیست، این دوره مناسب
            شما نخواهد بود.
          </li>
          <li>
            علاوه بر استاد، همیشه پشتیبانی و منتور خواهید داشت. در یک گروه رفع
            اشکال، همراه با منتور و استاد، قدم به قدم جلو می‌روید.
          </li>
          <li>
            هیچ دوره برنامه‌نویسی صفر تا صد واقعی وجود ندارد و هر کس چنین ادعایی
            می‌کند، احتمالا تجربه کمی دارد. هدف ما در بوت‌کمپ فرانت‌اند این است
            که از نقطه صفر به توانایی ورود به بازار کار و کار در تیم برسید.
          </li>
        </ul>
...
font-bold text-[1.8rem] sm:text-2xl mb-5 text-[rgb(63,66,100)] tracking-tight [text-shadow:0_0_1px_rgba(0,0,0,0.3)]      ">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
          <div className="bg-white space-y-3 rounded-xl p-4 text-center flex flex-col items-center">
            <h2 className="
            font-bold text-[1.3rem] sm:text-2xl text-[rgb(63,66,100)] tracking-tight [text-shadow:0_0_1px_rgba(0,0,0,0.3)]
            ">
  ...
  //   income
  {
    ...
    content: (
      <>
        <h2 className="
font-bold text-[1.8rem] sm:text-2xl mb-5 text-[rgb(63,66,100)] tracking-tight [text-shadow:0_0_1px_rgba(0,0,0,0.3)]        ">حداقل درآمد فرانت اند</h2>
        <p className="mb-2 text-base text-gray-700 leading-loose">
          ...
          حقوق یه جونیور در سال 1403 بین 25-35 میلیون تومان در شروع کار است.
          ...
          مثال دانشجوهایی رو داریم که بدون هیچ سابقه ای با حقوق 17 میلیون
          استخدام شدند و بعد 1 سال به حقوق بالای 40 میلیون هم رسیدند. دانشجویانی
          که بالای 2-3 سال سابقه کار دارن اکثرا با حقوق
        </p>
        <h2 className="
font-bold text-[1.8rem] sm:text-2xl mb-5 text-[rgb(63,66,100)] tracking-tight [text-shadow:0_0_1px_rgba(0,0,0,0.3)]        ">هزینه یا سرمایه گذاری؟</h2>
  ...
  //   presingin
  {
    ...
    content: (
      <>
        <h2 className="
font-bold text-[1.8rem] sm:text-2xl mb-5 text-[rgb(63,66,100)] tracking-tight [text-shadow:0_0_1px_rgba(0,0,0,0.3)]        "> مشاوره قبل ثبت نام</h2>
        <p className="mb-2 text-base text-gray-700 leading-loose">
  ...
  //   experience
  {
    ...
    content: (
      <>
        <h2 className="
font-bold text-[1.8rem] sm:text-2xl mb-5 text-[rgb(63,66,100)] tracking-tight [text-shadow:0_0_1px_rgba(0,0,0,0.3)]        "> تجربه دانشجویان</h2>
  ...
  // singin
  {
    ...
    content: (
      <>
        <h2 className="
font-bold text-[1.8rem] sm:text-2xl mb-5 text-[rgb(63,66,100)] tracking-tight [text-shadow:0_0_1px_rgba(0,0,0,0.3)]        ">ثبت نام</h2>
        <ul className="text-gray-700 leading-7 space-y-4">
          <li>
            ...
            <a
              ...
              rel="noreferrer"
            >
              اکانت پشتیبانی تلگرام
            </a>
            ارسال کنید تا هزینه نهایی بوت‌کمپ برای شما محاسبه شود.
          </li>

          <li>
            اگر تا به امروز دانشجوی دوره‌های فرانت‌هوکس نبودید، می‌توانید از
            طریق لینک زیر هزینه را واریز کنید. لطفاً پس از پرداخت، اکانت خود را
            در سایت بسازید و شماره موبایل و رسید واریزی را برای پشتیبانی تلگرام
            ارسال نمایید.
          </li>

          <li>
            ظرفیت بوت‌کمپ فقط
            <strong>۳۰ نفر</strong>
          ...
          <li>
            با ثبت‌نام در بوت‌کمپ توسعه فرانت‌اند با ری‌اکت، فرصتی عالی برای
            یادگیری مهارت‌های تخصصی و ورود به دنیای توسعه فرانت‌اند به دست
            خواهید آورد. همین حالا اقدام کنید و جای خود را رزرو کنید؛ فرصت رشد
            بی‌پایان است، اما زمان ثبت‌نام محدود!
          </li>

          <li>
            ثبت‌نام در بوت‌کمپ به منزله
            <strong>مطالعه کامل و آگاهی دقیق</strong>
            از تمام موارد مطرح‌شده، پذیرش قوانین و شرایط سایت فرانت‌هوکس، و
            پایبندی به تمام بندهای بوت‌کمپ است. همچنین ثبت‌نام در بوت‌کمپ شامل
            برگشت هزینه یا امکان انصراف نخواهد بود.
          </li>

          <li>در پرداخت قسطی، فاصله‌ی پرداخت هر قسط یک ماه است.</li>
        </ul>
      </>
    ),
  },
